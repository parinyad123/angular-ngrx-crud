...
// การสร้าง Action Types 
export const LOAD_EMPLOYEE = 'employee getall'
export const LOAD_EMPLOYEE_SUCESS = 'employee getall suc'
export const LOAD_EMPLOYEE_FAIL = 'employee getall fail'

export const DELETE_EMPLOYEE = '[employee] dalete'
...
// การสร้าง Action Creators 
export const loadEmployee = createAction(LOAD_EMPLOYEE)
export const loadEmployeeSuc = createAction(LOAD_EMPLOYEE_SUCESS, props<{ list: Employee[] }>())
